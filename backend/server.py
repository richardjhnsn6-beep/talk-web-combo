...
from routes.content_access import router as content_access_router
...
# Include Content Access routes with /access prefix
api_router.include_router(content_access_router, prefix="/access", tags=["content-access"])
