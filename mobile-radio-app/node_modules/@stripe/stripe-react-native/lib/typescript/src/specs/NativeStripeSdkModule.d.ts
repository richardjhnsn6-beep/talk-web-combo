...
export interface Spec extends TurboModule {
    ...
    clientSecretProviderSetupIntentClientSecretCallback(setupIntentClientSecret: string): Promise<void>;
    clientSecretProviderCustomerSessionClientSecretCallback(customerSessionClientSecret: UnsafeObject<CustomerSessionClientSecret>): Promise<void>;
    ...
    downloadAndShareFile(url: string, filename?: string | null): Promise<{
        success: boolean;
        error?: string;
    }>;
