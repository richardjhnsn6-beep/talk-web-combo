...
export declare function addOnrampListener<EventT extends OnrampEvents>(event: EventT, handler: Parameters<(typeof NativeOnrampSdkModule)[EventT]>[0]): EventSubscription;
export {};
