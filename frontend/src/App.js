...
const Navigation = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <nav 
      className={`bg-teal-700 text-white w-64 fixed left-0 top-0 p-6 flex flex-col z-50 transition-transform duration-300 ease-in-out ${
      ...
      <BrowserRouter>
        ...
        <div className="md:ml-64">
          <Routes>
            ...
            <Route path="/book-preview" element={<AdminLogin><BookPreview /></AdminLogin>} />
