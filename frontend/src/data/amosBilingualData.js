// Shared Book of Amos chapter data - extracted to a shared module
// so that both the reading view (BookOfAmos.js) and the printable
// book preview (BookPreview.js) can reuse the same source of truth.

export const chapter1Interlinear = {
  verse1: {
...
export const chapter2Interlinear = {
  verse1: {
...
export const chapter3Interlinear = {
  verse1: {
...
export const chapter4Interlinear = {
  verse1: {
...
export const chapter5Interlinear = {
  verse1: {
...
export const chapter6Interlinear = {
  verse1: {
...
export const chapter7Interlinear = {
  verse1: {
...
export const chapter8Interlinear = {
  verse1: {
...
export const chapter9Interlinear = {
  verse1: {
...
export const chapter4Bilingual = [
  { 
    verse: 1, 
    hebrew: "Shama Zah adabar attanah pharach al Bashan ky hy al har al Shamarwn Asar Ashaq dal Asar ratsats abyown Cham adabar amar Cham adown bow aw yanach anachnw Shathah",
    english: "Hear this word ye kine of Bashan that are in the mountain of Samaria which oppress the poor which Crush the needy their word say to their masters bring and Let us drink"
...
export const chapter1Bilingual = [
  { 
    verse: 1, 
...
export const interlinearToBilingual = (interlinearData) => {
