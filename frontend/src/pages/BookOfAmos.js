...
const BookOfAmos = () => {
  ...
  const chapter2Interlinear = {
    ...
    verse9: {
      hebrew: ["awd", "Shamad", "Any", "phanym", "Cham", "Asar", "gabahh", "hayach", "kamah", "al", "Araz", "aw", "haw", "hayach", "Chacan", "allaw", "awd", "Any", "Shamad", "Naphash", "aphray", "Maal", "Aw", "Naphash", "Sharash", "al", "Tachath"],
      english: ["yet", "destroyed", "I", "before them", "whose", "height", "was", "like the", "cedars", "and", "he", "was", "strong as the", "oak", "yet", "I", "destroyed", "his", "fruit", "from above", "and", "his", "roots", "from", "beneath"]
    },
    verse10: {
